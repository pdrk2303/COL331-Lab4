...
main(int argc, char *argv[])
{
  ...
  15:	68 d8 08 00 00       	push   $0x8d8
  1a:	6a 01                	push   $0x1
  1c:	e8 ff 04 00 00       	call   520 <printf>
	mem();
...
00000030 <mem>:
{
  ...
  3a:	83 ec 1c             	sub    $0x1c,%esp
	int upt1 = uptime();
  3d:	e8 09 04 00 00       	call   44b <uptime>
	printf(1, "mem test\n");
  42:	83 ec 08             	sub    $0x8,%esp
  45:	68 88 08 00 00       	push   $0x888
  4a:	6a 01                	push   $0x1
	int upt1 = uptime();
  4c:	89 45 dc             	mov    %eax,-0x24(%ebp)
	printf(1, "mem test\n");
  4f:	e8 cc 04 00 00       	call   520 <printf>
	m1 = malloc(4096);
  54:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  5b:	e8 20 07 00 00       	call   780 <malloc>
	if (m1 == 0)
  60:	83 c4 10             	add    $0x10,%esp
	m1 = malloc(4096);
  63:	89 45 e0             	mov    %eax,-0x20(%ebp)
	if (m1 == 0)
  66:	85 c0                	test   %eax,%eax
  68:	74 5c                	je     c6 <mem+0x96>
  6a:	89 c7                	mov    %eax,%edi
	uint count = 0;
  6c:	31 f6                	xor    %esi,%esi
  6e:	eb 3e                	jmp    ae <mem+0x7e>
		printf(1,"%d\n",sizeof(int));
  70:	83 ec 04             	sub    $0x4,%esp
		*(char**)m1 = m2;
  73:	89 03                	mov    %eax,(%ebx)
		((int*)m1)[2] = count++;
  75:	8d 4e 01             	lea    0x1(%esi),%ecx
  78:	89 73 08             	mov    %esi,0x8(%ebx)
		printf(1,"%d\n",sizeof(int));
  7b:	6a 04                	push   $0x4
  7d:	68 9d 08 00 00       	push   $0x89d
  82:	6a 01                	push   $0x1
		((int*)m1)[2] = count++;
  84:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		printf(1,"%d\n",sizeof(int));
  87:	e8 94 04 00 00       	call   520 <printf>
		printf(1, "CurrCount: %d\n", ((int*)m1)[2]);
  8c:	83 c4 0c             	add    $0xc,%esp
  8f:	ff 73 08             	pushl  0x8(%ebx)
  92:	68 92 08 00 00       	push   $0x892
  97:	6a 01                	push   $0x1
  99:	e8 82 04 00 00       	call   520 <printf>
	while (cur < TOTAL_MEMORY) {
  9e:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  a1:	83 c4 10             	add    $0x10,%esp
  a4:	81 f9 60 02 00 00    	cmp    $0x260,%ecx
  aa:	74 2e                	je     da <mem+0xaa>
  ac:	89 ce                	mov    %ecx,%esi
		m2 = malloc(4096);
  ae:	83 ec 0c             	sub    $0xc,%esp
  b1:	89 fb                	mov    %edi,%ebx
  b3:	68 00 10 00 00       	push   $0x1000
  b8:	e8 c3 06 00 00       	call   780 <malloc>
		if (m2 == 0)
  bd:	83 c4 10             	add    $0x10,%esp
		m2 = malloc(4096);
  c0:	89 c7                	mov    %eax,%edi
		if (m2 == 0)
  c2:	85 c0                	test   %eax,%eax
  c4:	75 aa                	jne    70 <mem+0x40>
	printf(1, "MemTest1 failed!\n");
  c6:	83 ec 08             	sub    $0x8,%esp
  c9:	68 c6 08 00 00       	push   $0x8c6
  ce:	6a 01                	push   $0x1
  d0:	e8 4b 04 00 00       	call   520 <printf>
	exit();
  d5:	e8 d9 02 00 00       	call   3b3 <exit>
	((int*)m1)[2] = count;
  da:	c7 47 08 60 02 00 00 	movl   $0x260,0x8(%edi)
	printf(1, "\n\nWhile Loop Over\n");
  e1:	53                   	push   %ebx
  e2:	53                   	push   %ebx
  e3:	68 a1 08 00 00       	push   $0x8a1
  e8:	6a 01                	push   $0x1
  ea:	e8 31 04 00 00       	call   520 <printf>
  ef:	83 c4 10             	add    $0x10,%esp
	count = 0;
  f2:	31 c0                	xor    %eax,%eax
  f4:	eb 1c                	jmp    112 <mem+0xe2>
  f6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  fd:	8d 76 00             	lea    0x0(%esi),%esi
		m1 = *(char**)m1;
 100:	8b 55 e0             	mov    -0x20(%ebp),%edx
		count++;
 103:	83 c0 01             	add    $0x1,%eax
		m1 = *(char**)m1;
 106:	8b 12                	mov    (%edx),%edx
 108:	89 55 e0             	mov    %edx,-0x20(%ebp)
	while (count != total_count) {
 10b:	3d 60 02 00 00       	cmp    $0x260,%eax
 110:	74 1b                	je     12d <mem+0xfd>
		if (((int*)m1)[2] != count)
 112:	8b 55 e0             	mov    -0x20(%ebp),%edx
 115:	3b 42 08             	cmp    0x8(%edx),%eax
 118:	74 e6                	je     100 <mem+0xd0>
			printf(1, "CurrCount: %d\n", count);
 11a:	51                   	push   %ecx
 11b:	50                   	push   %eax
 11c:	68 92 08 00 00       	push   $0x892
 121:	6a 01                	push   $0x1
 123:	e8 f8 03 00 00       	call   520 <printf>
			goto failed;
 128:	83 c4 10             	add    $0x10,%esp
 12b:	eb 99                	jmp    c6 <mem+0x96>
	int upt2 = uptime();
 12d:	e8 19 03 00 00       	call   44b <uptime>
	int diff = upt2-upt1;
 132:	2b 45 dc             	sub    -0x24(%ebp),%eax
	printf(1, "MemTest1 Passed!\n", diff);
 135:	52                   	push   %edx
 136:	50                   	push   %eax
 137:	68 b4 08 00 00       	push   $0x8b4
 13c:	6a 01                	push   $0x1
 13e:	e8 dd 03 00 00       	call   520 <printf>
	exit();
 143:	e8 6b 02 00 00       	call   3b3 <exit>
 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4a9:	0f b6 92 f4 08 00 00 	movzbl 0x8f4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb ea 08 00 00       	mov    $0x8ea,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 bc 0b 00 00       	mov    0xbbc,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 bc 0b 00 00       	mov    %eax,0xbbc
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 bc 0b 00 00       	mov    %eax,0xbbc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d bc 0b 00 00    	mov    0xbbc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d bc 0b 00 00    	mov    0xbbc,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 bc 0b 00 00       	mov    0xbbc,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 bc 0b 00 00       	mov    %eax,0xbbc
}
 ...
 84e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 bc 0b 00 00 c0 	movl   $0xbc0,0xbbc
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf c0 0b 00 00       	mov    $0xbc0,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 c0 0b 00 00 c0 	movl   $0xbc0,0xbc0
 866:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 872:	00 00 00 
    if(p->s.size >= nunits){
